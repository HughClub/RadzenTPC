...
namespace RadzenDb
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseMySql(Configuration.GetConnectionString("TpcHConnection"), ServerVersion.AutoDetect(Configuration.GetConnectionString("TpcHConnection")));
            ...
            services.AddScoped<TpcHService>();

            services.AddDbContext<RadzenDb.Data.TpcHContext>(options =>
            {
              options.UseMySql(Configuration.GetConnectionString("TpcHConnection"), ServerVersion.AutoDetect(Configuration.GetConnectionString("TpcHConnection")));
            });
