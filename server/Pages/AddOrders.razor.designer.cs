...
{
    public partial class AddOrdersComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            order = new RadzenDb.Models.TpcH.Order(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(RadzenDb.Models.TpcH.Order args)
        {
            try
            {
                var tpcHCreateOrderResult = await TpcH.CreateOrder(order);
                DialogService.Close(order);
            }
            catch (System.Exception tpcHCreateOrderException)
            {
